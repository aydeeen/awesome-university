      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            <li <?php if (get_post_type() == 'coolevent' or is_page('past-events')) echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('coolevent'); ?>">CoolEvents</a></li>
